...
Eli Wood
2026-03-30
Page for viewing machines and their availability
-->
...
<body>
        ...
        <div class="container nav-container">
            ...
            <nav class="nav">
                <ul class="nav-list">
                    ...
                    <li><a href="scheduling.php" class="nav-link active"><span class="link-text">Scheduling</span><span
                                class="mobile-arrow">&rsaquo;</span></a></li>
    ...
    <section class="machines section-animate slide-up">
        <div class="container schedule-container">
            <div class="section-tag">
                <span class="line"></span> SCHEDULING
            </div>
