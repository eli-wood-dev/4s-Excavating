...
<body>
                        ...
                        <div class="form-control">
                            ...
                            <div class="select-wrapper">
                                <select id="category" name="category" required>
                                    <option value="service" selected>Service Question</option>
                ...
                <div class="contact-info-col">
                    <div class="contact-info-card">
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-text">
                                <h3>Our Office</h3>
                                <p>58 Dalhousie St., Brantford, ON N3T 2J0.</p>
                            </div>
                        </div>
                        <div class="info-item">
                            <div class="info-icon">
                            ...
                            <div class="info-text">
                                ...
                                <p>M-F: 8am - 6pm<br>S-S: 10am - 4pm</p>
                            </div>
                        </div>
                        <div class="info-item">
                            <div class="info-icon">
                            ...
                            <div class="info-text">
                                <h3>Get in Touch</h3>
                                <p>service@4sexcavating.com<br>519-756-7050</p>
                            </div>
                        </div>
                        <div class="info-socials">
                            ...
                            <a href="#" aria-label="LinkedIn"><svg width="18" height="18" viewBox="0 0 24 24"
    ...
    <div id="status-modal" class="modal">
        <div class="modal-content slide-left" id="modal-content">
            <span class="close-btn" id="close-modal-btn">&times;</span>
            <h2 id="modal-title">Status</h2>
            <p id="modal-text">Message goes here.</p>
        </div>
    </div>
